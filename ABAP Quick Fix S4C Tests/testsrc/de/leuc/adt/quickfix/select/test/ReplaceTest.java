...
//                     + "    select single *\n      FROM wbit \"\"test\n      iNto @data(result)\r\n      where tkonn = @tkonn and tposn = @tposn.";
    ...
    /*
     *
     * select single * from wbit into @data(result) where tkonn eq @tkonn and tposn
     * = @tposn and tposn = @tposn and tposn = @tposnselect * from wbit and tposn
     * = @tposn into @data(result) and tposn = @tposn up to 1 rows and tposn
     * = @tposn where and tposn = @tposn tkonn eq @tkonn and tposn = @tposn and
     * tposn = @tposn order by primary key. and tposn = @tposnendselect..
     */
}
